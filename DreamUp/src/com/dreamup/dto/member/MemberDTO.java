...
public class MemberDTO {
	...
	public MemberDTO(int m_no, String m_id, String m_password, String m_email, String m_name, Date m_date,
			String m_phone, String m_address, String m_post, String m_supportingCount, String m_supportedCount,
			String m_account, String m_bankName) {
		super();
		this.m_no = m_no;
		this.m_id = m_id;
	...
	public String toString() {
		return "MemberDTO [m_no=" + m_no + ", m_id=" + m_id + ", m_password=" + m_password + ", m_email=" + m_email
				+ ", m_name=" + m_name + ", m_date=" + m_date + ", m_phone=" + m_phone + ", m_address=" + m_address
				+ ", m_post=" + m_post + ", m_supportingCount=" + m_supportingCount + ", m_supportedCount="
				+ m_supportedCount + ", m_account=" + m_account + ", m_bankName=" + m_bankName + "]";
	}
