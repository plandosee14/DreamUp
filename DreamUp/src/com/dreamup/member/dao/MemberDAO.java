...
public class MemberDAO {
	...
	// 사용자 세션 부여시
	/*
	 * public MemberDTO selectMember(int m_no){ try { MemberDTO result; result = (MemberDTO) sqlMap.queryForObject("member.selectMember",m_no); return
	 * result; } catch (SQLException e) { // TODO Auto-generated catch block e.printStackTrace(); } return null; }
	 */
