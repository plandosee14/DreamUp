	...
	<div class="pro-info">
		...
		<div class="row">
			...
			<div class="col-sm-3" style="background-color: white;">
				<center>
					<font size="5px"><b>${project.su_count}</b></font><br> 후원자수<br>
					<br> <font size="5px"><b>${project.now_amount}</b></font><br>
					현재 후원액 <br>
					<br> <font size="5px"><b>${proDetail.pro_goal}</b></font><br>
					목표액 <br>
					<br> <font size="5px"><b>${proDetail.due_date}</b></font><br>
					잔여기간 <br>
			...
			<div class="col-sm-3" style="background-color: white;">
				...
				<c:forEach items="${rewardList}" var="rewardList">
                  ...
                  <tr>
						...
						<table align="center">
							<center>${rewardList.re_title}<br> 보상 품목 :
								${rewardList.re_item} <br> 배송 예정일 :
								${rewardList.re_delivery} <br> 남은 수량 :
								${rewardList.re_limite} <br> <input type="text"
									name="re_money" id="re_money" value="${rewardList.re_money}">원
								<br>
							</center>
