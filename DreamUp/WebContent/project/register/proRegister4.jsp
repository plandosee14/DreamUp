		...
		<body>
			...
			<form action="pro_file.do" method="post"
				...
				<table border="1" width="400" height="100">
					<tr>
						<td>프로필 사진<input type="file" name="myfile"><br>
						</td>
					</tr>
				</table>
				...
				<table border="1" width="400" height="30">
					<tr>
						<td>등록자 이름<input type="text" size="10" value="이름">
						</td>
					</tr>
				</table>
				...
				<table border="1" width="400" height="30">
					<tr>
						<td>소개<br><textarea rows="5" cols="54" name="pro_fileIntro">
 </textarea>
						</td>
					</tr>
				</table>
				...
				<table border="1" width="400" height="100">
					...
					<tr>
						<td>주소<!--  <input type="text" name="Pro_zip"><br> --> <input
							type="text" name="pro_address"> <input type="button"
							value="주소찾기">
							<div>
								<center>
							</div>
				...
				<table border="1" width="400" height="30">
					<tr>
						<td>SNS &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text"
							size="40" name="pro_fileSns">
